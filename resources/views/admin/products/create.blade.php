                ...
                <form id="jquery-val-form" method="post" action="{{route('products.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="mb-1 col-md-6">
                            ...
                            <input type="text" class="form-control" id="basic-default-name" name="product_name" placeholder="اسم المنتج - مثال: شيبسي" required/>
                        </div>
                        ...
                        <div class="mb-1 col-md-6">
                            ...
                            <select class="form-select select2" id="product_status_id" name="product_status_id">
                        ...
                        <div class="mb-1 col-md-6">
                            ...
                            <select class="form-select select2" id="product_accept_id" name="product_accept_id">
